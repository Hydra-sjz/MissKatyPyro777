...
@control_user
async def animegojosatu(client: Client, message: Message, mdata: dict):
    """Search Anime Info"""
...
@control_user
async def mangagoh_cmd(client: Client, message: Message, mdata: dict):
    """Search Manga Info"""
    text = mdata["text"].split(" ", 1)
    gid = mdata["chat"]["id"]
    try:
...
@Client.on_message(filters.command("anilist"))
@control_user
...
@Client.on_message(filters.command(["flex", "user"]))
@control_user
...
@Client.on_message(filters.command("anisettings"))
@control_user
...
@Client.on_message(filters.command(["ame", "activity"]))
@control_user
...
@Client.on_message(filters.command("favourites"))
@control_user
...
@Client.on_message(filters.command(["getgenres", "gettags"]))
@control_user
