...
from misskaty.ultis_ex.wmilia_m.actions import failedAction, passedAction
from misskaty.ultis_ex.wmilia_m.captcha_text_gen import ButtonGen
from misskaty.ultis_ex.wmilia_m.random_string_gen import (
    RandomStringGen,
    mathCaptchaGen,
)
...
@pgram.on_callback_query(filters.create(lambda _, __, query: "textc_" in query.data))
