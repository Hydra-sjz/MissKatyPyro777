...
from misskaty.vars import GOOGLEAI_KEY, LOG_CHANNEL
...
#=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×
@app.on_message(filters.command("askai") pyro_cooldown.wait(10))
...
@app.on_message(filters.command("aii") pyro_cooldown.wait(10))
...
@app.on_message(filters.command("aicook") pyro_cooldown.wait(10))
...
@app.on_message(filters.command("aiseller") pyro_cooldown.wait(10))
